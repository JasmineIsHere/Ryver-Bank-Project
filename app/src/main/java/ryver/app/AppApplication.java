...
import ryver.app.account.AccountController;
...
public class AppApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("[Add Account for user1]: new AccountID = " + accounts.addAccount(user1.getUID(),12345L,50000,5000).getAID());
		System.out.println("[Add Account for user2]: new AccountID = " + accounts.addAccount(user2.getUID(),12346L,50000,5000).getAID());
