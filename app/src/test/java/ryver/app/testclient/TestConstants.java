 ...
 * will be used in the actual testing (Week 12).
 * 
 ...
 * 4) You can now run the whole test suite using Java Test Runner (refer to week 6's lab)
 *    (note that the test files will be run sequentially, A_Customer, then B_Content, and so on) from within VS Code
 *    
...
public class TestConstants {
    ...
    public static final double account_balance_2 = 10000.0;
