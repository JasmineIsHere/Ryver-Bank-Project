...
public class A_CustomerTest {
    ...
    /**
     * Test add/get a new user successfully
     * @throws Exception
     */
    @Test
    @Order(2)
    public void testAddGetUser_Valid_ReturnJson() throws Exception{
        JSONObject requestParams = new JSONObject();
        requestParams.put("full_name", "John Tan"); 
        requestParams.put("nric", nric2);
        requestParams.put("phone", "93223435");
        requestParams.put("address", "28 Jalan Alamak S680234");
        ...
        given()
         ...
         // view by another user - forbidden
        given().auth().basic(TestConstants.u1_USERNAME, TestConstants.u1_PASSWORD)
                .accept("*/*")
                .contentType("application/json")
                .get(TestConstants.customerURL + "/" + TestConstants.user_id_2)
